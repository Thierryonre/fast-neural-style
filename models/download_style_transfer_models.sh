...
mkdir -p ../eccv16
cd ../eccv16
wget -N --no-check-certificate "$BASE_URL/eccv16/the_wave.t7"
wget -N --no-check-certificate "$BASE_URL/eccv16/starry_night.t7"
wget -N --no-check-certificate "$BASE_URL/eccv16/la_muse.t7"
wget -N --no-check-certificate "$BASE_URL/eccv16/composition_vii.t7"
cd ../../
